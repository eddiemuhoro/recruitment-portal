        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We believe that finding the right job should be simple and efficient. Our platform
              connects talented professionals with leading companies, creating meaningful
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                We believe in building trust through complete transparency in our processes.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                We prioritize building a strong community of professionals and employers.
              </p>
            </div>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8">
            Be part of our mission to transform the job search experience.
          </p>
          <a
            href="/contact"
