    ...
    <div className="flex flex-col h-[600px] w-full max-w-2xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {isLoading && (
          ...
          >
            <div className="bg-gray-50 rounded-lg p-4 text-gray-800 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t bg-gray-50">
        <div className="flex space-x-2">
          <input
            ...
            placeholder="Ask me anything about jobs or the company..."
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 flex items-center gap-2 transition-colors duration-200"
          >
            <FaPaperPlane />
            <span>Send</span>
          </button>
